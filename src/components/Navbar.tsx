      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <a href="https://drive.google.com/file/d/1GTxvQdtDxS1o2VUb5tOKqYH2S2x8yXeq/view?usp=sharing" target="_blank" className="text-gray-700 hover:text-gray-900 transition-colors">Download CV</a>
            <div className="flex items-center space-x-4">
              ...
              <a href="https://www.linkedin.com/in/jaskiratsingh13/" target="_blank" rel="noopener noreferrer" className="text-gray-700 hover:text-gray-900">
                <Linkedin className="w-5 h-5" />
              </a>
              <a href="mailto:jaskirat.singh1412@gmail.com" className="text-gray-700 hover:text-gray-900">
